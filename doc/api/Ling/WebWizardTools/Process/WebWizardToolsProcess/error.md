...
Source Code
===========
See the source code for method [WebWizardToolsProcess::error](https://github.com/lingtalfi/WebWizardTools/blob/master/Process/WebWizardToolsProcess.php#L431-L434)
